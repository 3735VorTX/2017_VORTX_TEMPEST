...
public class Navigation extends SensorBase  implements PIDSource{
	public static final boolean SENSOR_TYPE_SPI450 = true;
	public static final boolean SENSOR_TYPE_NAVX = false;

	private AHRS ahrs;
	private Gyro gyrospi;
	...
	public double  getRate() {
		double rate=0;
		if (SENSOR_TYPE_NAVX)
			rate = ahrs.getVelocityX();
		if (SENSOR_TYPE_SPI450)
			rate = gyrospi.getRate();
		return rate;
