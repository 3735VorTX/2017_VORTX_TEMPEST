...
public class OI implements DriveOI {
	...
	public OI() {
		...
		pov0.whenPressed(new DriveTurnToOffsetGyroHeading(0));
		pov45.whenPressed(new DriveTurnToOffsetGyroHeading(45));
		pov90.whenPressed(new DriveTurnToOffsetGyroHeading(90));
		pov135.whenPressed(new DriveTurnToOffsetGyroHeading(135));
		pov180.whenPressed(new DriveTurnToOffsetGyroHeading(180));
		pov225.whenPressed(new DriveTurnToOffsetGyroHeading(-135));
		pov270.whenPressed(new DriveTurnToOffsetGyroHeading(-90));
		pov315.whenPressed(new DriveTurnToOffsetGyroHeading(-45));
