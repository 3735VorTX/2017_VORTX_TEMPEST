 ...
 *
 */
public class TurnToAngleProfile extends Command {
    ...
    public TurnToAngleProfile(double a) {
    	targetAngle = a;
...
//FIXME  startAngle = Robot.drive.getYaw();
 ...
 //FIXME   	currentAngle = Robot.drive.getYaw();
