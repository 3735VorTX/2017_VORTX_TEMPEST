 ...
 *
 */
public class DriveMoveDistanceTwist extends Command {
	...
	public DriveMoveDistanceTwist(double distance) {
		// Use requires() here to declare subsystem dependencies
		// eg. requires(chassis);
		requires(Robot.drive);
		this.displacementInches = distance/3;
	...
	protected void initialize() {
		...
		Robot.drive.setPIDSettings(0.02, 0.00002, 0.0,0,0,0);
...
//			}
//		} else {
			Robot.drive.setPIDSettings(0.01, 0.00005, 0,0,0,0);
			Robot.drive.setLeftRightDistance(endPositionLeftInches, endPositionRightInches);
		//}
